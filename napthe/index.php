<!DOCTYPE html>
  ...
  <body>
      <script type="text/javascript"> new WOW().init(); </script>
		...
		<div align='center' class='mt-2 mb-2'>
    		<button class='btn btn-primary' onclick="location.href='http://minesoya.com'">HOME</button>
    		<button class='btn btn-primary' onclick="location.href='http://minesoya.com/history.php'">LỊCH SỬ</button>
			<button class='btn btn-primary' onclick="location.href='http://minesoya.com/vote.php'">VOTE</button>
    		<button class='btn btn-primary' onclick="location.href='http://minesoya.com/napthe/index.php'">NẠP THẺ</button>
			<button class='btn btn-primary' onclick="location.href=''http://minesoya.com/helper.php'">HELPER</button>
    		<button class='btn btn-primary' onclick="location.href='http://minesoya.com/contact.php'">CONTACT</button>
		</div>
		   <div id="status"></div>
		<div class="row" style="margin-top: 30px;">
			<div class="col-md-5">
				<form method="POST" action="#" id="myform">
                 ...
                 <td><center><p><b>Nhập những kí tự bạn thấy vào ô bên dưới !</b></p><img width="30%" id="captcha_code" src="./ajax/captcha_code.php" onclick="refreshCaptcha();" />
  ...
  <thead>
    ...
    <div id="collapsep" class="collapse" aria-labelledby="headingp" data-parent="#accordion">
      <div class="card-body table-responsive">
        <ul>
		  <!-- <li>Tài khoản dùng để đổi thẻ cào thành tiền mặt theo chiết khấu quy định tại từng thời điểm.</li>  -->
...
<footer align='center'>
	<?php echo "<p>Copyright &copy; 2017-" . date("Y") . " MineSoya.com</p>"; ?>
</footer>
</html>		